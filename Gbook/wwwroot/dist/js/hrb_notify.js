...
function hrb_notify([Type,Pic,Icon, Text, Position, easeIn, easeOut, timeout]) {
    ...
    if (Icon != "") {
        $Icon = `<i class="IconNotify fal ${Icon}"/></i>`;
    } else {
        $Icon = '';
    }
    if (Pic != "") {
        $Pic = `<img src="${Pic}" class="picShow"/>`;
    } else {
        $Pic = '';
    }
    if (easeOut != "") {
    ...
    switch (Type) {
        case 'success' :
            $Type = '<div class="box_hrb_notify hrb_notify_success" ease-in="'+$easeIn+'" ease-out="'+$easeOut+'" data-count="' + count_hrb_notify + '"><i class="close fa fa-times" data-count="' + count_hrb_notify + '"></i><i class="progress_hrb_notify" style="transition: all ' + $timeout + 's"></i>' + $Pic + '  ' + $Text + '  ' + $Icon +'</div>';
            break;
        case 'homekito' :
            $Type = '<div class="box_hrb_notify hrb_notify_homekito" ease-in="'+$easeIn+'" ease-out="'+$easeOut+'" data-count="' + count_hrb_notify + '"><i class="close fa fa-times" data-count="' + count_hrb_notify + '"></i><i class="progress_hrb_notify" style="transition: all ' + $timeout + 's"></i>' + $Pic + '  ' + $Text + '  ' + $Icon +'</div>';
            break;
        case 'danger' :
            $Type = '<div class="box_hrb_notify hrb_notify_danger" ease-in="'+$easeIn+'" ease-out="'+$easeOut+'"  data-count="' + count_hrb_notify + '"><i class="close fa fa-times" data-count="' + count_hrb_notify + '"></i><i class="progress_hrb_notify" style="transition: all ' + $timeout + 's""></i>' + $Pic + '  ' + $Text + '  ' + $Icon +'</div>';
            break;
        case 'warning' :
            $Type = '<div class="box_hrb_notify hrb_notify_warning" ease-in="'+$easeIn+'" ease-out="'+$easeOut+'"  data-count="' + count_hrb_notify + '"><i class="close fa fa-times" data-count="' + count_hrb_notify + '"></i><i class="progress_hrb_notify" style="transition: all ' + $timeout + 's""></i>' + $Pic + '  ' + $Text + '  ' + $Icon +'</div>';
            break;
        case 'info' :
            $Type = '<div class="box_hrb_notify hrb_notify_info" ease-in="'+$easeIn+'" ease-out="'+$easeOut+'"  data-count="' + count_hrb_notify + '"><i class="close fa fa-times" data-count="' + count_hrb_notify + '"></i><i class="progress_hrb_notify" style="transition: all ' + $timeout + 's""></i>' + $Pic + '  ' + $Text + '  ' + $Icon +'</div>';
            break;
        default :
            break;
    }
