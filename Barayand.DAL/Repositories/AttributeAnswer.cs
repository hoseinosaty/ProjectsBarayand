...
{
    public class AttributeAnswer : GenericRepository<AttrAnswerModel>, IPublicMethodRepsoitory<AttrAnswerModel>
    {
        private readonly BarayandContext _context;

        public AttributeAnswer(BarayandContext context):base(context)
        {
